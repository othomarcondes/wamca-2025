...
both using the =lws= scheduler.

#+name: fig.trace4
#+caption: Application workers behavior along time in the 3\times2 and 6\times1 data distributions and using the =lws= scheduler respectively.
#+attr_latex: :width \linewidth
