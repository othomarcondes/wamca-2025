...
the scheduler heuristic cite:faverge2023programming.
...
Chameleon cite:agullo:inria-00547847, as other linear algebra
libraries such as DPLASMA cite:bosilca2011flexible are built on
task-based runtimes, which allows them to efficiently exploit their
computational resources of clusters. The scheduler heuristics studied
