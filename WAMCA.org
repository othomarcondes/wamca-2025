...
** 2025-09-07 Let's take a look into the traces
*** TODO Problem
...
#+name: fig.trace1
#+caption: Node occupation along the execution time considering the three =LU= tasks of two runs with the =lws= scheduler and the 3\times2 data partitioning for =openmpi= (top) and =nmad= (bottom).
#+attr_latex: :width .9\linewidth
