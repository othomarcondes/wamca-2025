...
The paper is structured as follows. Section [[sec:related_work]] presents some related work on static data partition and how task-based runtimes systems allowed and facilitated the implementation of these data distributions strategies. Section [[sec:methodology]] details
