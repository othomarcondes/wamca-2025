...
ggsave("img/distrib-scheduler.pdf", width=13, height=10)
#+end_src
...
** 2025-09-04 "data/nmad-times.csv"
...
Id      Function            threads        gpus         P       
 ...
 Max.   :14400   Max.   :1.804e+09   Max.   :14400   Max.   :0  
      time           gflops       KEY    
 Min.   :35.18   Min.   :32.51   1x6:40  
 1st Qu.:39.38   1st Qu.:39.59   2x3:40  
 Median :43.52   Median :45.74   3x2:40  
 Mean   :46.19   Mean   :44.21   6x1:40  
...
| <l>  | <l>                              | <l>        | <l>     |
|------+----------------------------------+------------+---------|
| Cei  | Supermicro X11DPU                | 96 GB DDR4 | 10G     |
|      | 2 x Intel(R) Xeon(R) Silver 4116 |            |         |
...
the comparison of the block-cyclic strategies and the intra-node
scheduler and their impact on the makespan, and finally an analysis
comparing NMAD and OMPI.
...
input matrix of 16K, as a function of different block sizes. We employ
violin plots cite:hintze1998violin, a well-known method to visually
depict the measurement distribution. We can see that the makespan is
