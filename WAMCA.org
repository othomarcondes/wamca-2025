...
distribution. We can observe that both the executions have similar
behavior, with =dgemm= tasks representing the major part of the first
10s, and a mean idle time of \approximate1100ms.
