...
#+begin_export latex
\institute{Institute of Informatics, Federal University of Rio Grande do Sul (UFRGS), Brazil \\
\includegraphics[width=.12\textwidth]{img/UFRGS.pdf}%
\hspace{.5 cm}%
\includegraphics[width=.12\linewidth]{./logo/ppgc.png}%
\hspace{.5 cm}%
\raisebox{0.2\height}{\includegraphics[width=.06\linewidth]{./logo/capes.png}}%
\hspace{.5 cm}%
\raisebox{0.5\height}{\includegraphics[width=.12\linewidth]{./logo/cnpq.png}}%
\hspace{.5 cm}%
\includegraphics[width=.12\linewidth]{./logo/fapergs.jpg}%
\hspace{.5 cm}%
\includegraphics[width=.12\linewidth]{./logo/petrobras.jpg}%
\hspace{.5 cm}%
}
#+end_export
...
The experiments in this work used the PCAD infrastructure, at
INF/UFRGS.  We also acknowledge the Brazilian National Council for
Scientific Technological Development (CNPq) for their financial
scholarship support. This study was financed in part by the
Coordenação de Aperfeiçoamento de Pessoal de Nível Superior - Brasil
(CAPES) - Finance Code 001, the FAPERGS (16/354-8, 16/348-8),
Petrobras (2020/00182-5).
